...
const basicInfoContainer = document.querySelector('.FAQ-container:nth-of-type(1)');
const adoptionContainer = document.querySelector('.FAQ-container:nth-of-type(2)');
const HowToHelpContainer = document.querySelector('.FAQ-container:nth-of-type(3)');
